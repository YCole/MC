...
/**
 * Shows a hierarchy of {@link Preference} objects as lists. These preferences
 * will automatically save to {@link SharedPreferences} as the user interacts
 * with them. To retrieve an instance of {@link SharedPreferences} that the
 ...
 * root element should be a {@link PreferenceScreen}. Subsequent elements can
 * point to actual {@link Preference} subclasses. As mentioned above, subsequent
 ...
 * 
 * <p>
 * The fragment implementation itself simply populates the preferences when
 * created. Note that the preferences framework takes care of loading the
 * current values out of the app preferences and writing them when changed:
 * </p>
 * 
 * {@sample
 * development/samples/ApiDemos/src/com/example/android/apis/preference/
 * FragmentPreferences.java fragment}
 * 
 * @see Preference
...
public abstract class PreferenceFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TypedArray a = getActivity().obtainStyledAttributes(null,
                R.styleable.PreferenceFragment, R.attr.preferenceFragmentStyle,
                0);

        mLayoutResId = a.getResourceId(
                android.R.styleable.PreferenceFragment_layout, mLayoutResId);
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (mList != null) {
                ...
                if (selectedItem instanceof Preference) {
                    ...
                    return ((Preference) selectedItem).onKey(selectedView,
                            keyCode, event);
                }
            }
            return false;
