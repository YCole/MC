...
import com.hct.gios.preference.VolumePreference.VolumeStore;
...
public class SeekBarVolumizer implements OnSeekBarChangeListener,
    ...
    public SeekBarVolumizer(Context context, int streamType, Uri defaultUri,
        ...
        if (defaultUri == null) {
            // HCT-SETTINGS-SOUND-MOD {
            /*
             * if (mStreamType == AudioManager.STREAM_RING) { defaultUri =
             * Settings.System.DEFAULT_RINGTONE_URI; } else if (mStreamType ==
             * AudioManager.STREAM_NOTIFICATION) { defaultUri =
             * Settings.System.DEFAULT_NOTIFICATION_URI; } else { defaultUri =
             * Settings.System.DEFAULT_ALARM_ALERT_URI; }
             */
            if (mStreamType == AudioManager.STREAM_RING) {
                defaultUri = RingtoneManager.getActualDefaultRingtoneUri(
        ...
        if (!isSamplePlaying()) {
            ...
            if (mRingtone != null) {
                try {
                    ...
                    Log.w(TAG, "Error playing ringtone, stream " + mStreamType,
                            e);
                }
            }
        }
    ...
    public void stop() {
        ...
        // HCT-SETTINGS-SOUND-RM preview sound for volume {
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final int streamValue = intent.getIntExtra(
                    AudioManager.EXTRA_VOLUME_STREAM_VALUE, -1);
            if (mSeekBar != null && streamType == mStreamType
                    && streamValue != -1) {
