...
/**
 * A {@link Preference} that allows the user to choose a ringtone from those on
 * the device. The chosen ringtone's URI will be persisted as a string.
 * <p>
 * If the user chooses the "Default" item, the saved string will be one of
 * {@link System#DEFAULT_RINGTONE_URI}, {@link System#DEFAULT_NOTIFICATION_URI},
 * or {@link System#DEFAULT_ALARM_ALERT_URI}. If the user chooses the "Silent"
...
public class RingtonePreference extends Preference implements
    ...
    public RingtonePreference(Context context, AttributeSet attrs,
        ...
        mRingtoneType = a.getInt(
                android.R.styleable.RingtonePreference_ringtoneType,
                RingtoneManager.TYPE_RINGTONE);
        mShowDefault = a.getBoolean(
                android.R.styleable.RingtonePreference_showDefault, true);
        mShowSilent = a.getBoolean(
                android.R.styleable.RingtonePreference_showSilent, true);
        a.recycle();
    }
    ...
    protected void onPrepareRingtonePickerIntent(Intent ringtonePickerIntent) {
        ...
        /*
         * if (mShowDefault) { if (getRingtoneType() ==
         * RingtoneManager.TYPE_RINGTONE) {
         * ringtonePickerIntent.putExtra(RingtoneManager
         * .EXTRA_RINGTONE_DEFAULT_URI,
         * RingtoneManager.getDefaultRingtoneUriBySubId(getSubId())); } else {
         */
        ringtonePickerIntent.putExtra(
