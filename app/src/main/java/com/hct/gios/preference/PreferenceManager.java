...
public class PreferenceManager {
     ...
     * defined by each {@link Preference} item's {@code android:defaultValue}
     ...
     *            as {@link android.content.Context#MODE_PRIVATE} or
     *            {@link android.content.Context#MODE_PRIVATE}
     * @param resId
     *            The resource ID of the preference XML file.
     * @param readAgain
     *            Whether to re-read the default values. If false, this method
     *            will set the default values only if this method has never been
     *            called in the past (or if the
     *            {@link #KEY_HAS_SET_DEFAULT_VALUES} in the default value
     *            shared preferences file is false). To attempt to set the
     *            default values again bypassing this check, set
