 ...
 */
public class SwitchPreferenceHCT extends TwoStatePreference {
    ...
    public class Listener implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView,
            ...
            SwitchPreferenceHCT.this.setChecked(isChecked);
        }
    }
     ...
     *            defaults.
     */
    public SwitchPreferenceHCT(Context context, AttributeSet attrs,
        ...
        setSummaryOn(a
                .getString(android.R.styleable.SwitchPreference_summaryOn));
        setSummaryOff(a
                .getString(android.R.styleable.SwitchPreference_summaryOff));
        setSwitchTextOn(a
                .getString(android.R.styleable.SwitchPreference_switchTextOn));
        setSwitchTextOff(a
                .getString(android.R.styleable.SwitchPreference_switchTextOff));
        setDisableDependentsState(a.getBoolean(
                android.R.styleable.SwitchPreference_disableDependentsState,
                false));
        a.recycle();
    }
     ...
     *            The Context that will style this preference
     */
    public SwitchPreferenceHCT(Context context) {
        this(context, null);
    }
    ...
    protected void onClick() {
        ...
        if (getIntent() == null && getFragment() == null) {
            ...
            setChecked(!(mSwitchView.isChecked()));
        }
    ...
    protected void onBindView(View view) {
        ...
        if (checkableView != null && checkableView instanceof Checkable) {
            ...
            if (checkableView instanceof Switch) {
                ...
                mSwitchView.setTextOn(mSwitchOn);
                mSwitchView.setTextOff(mSwitchOff);
                mSwitchView.setOnCheckedChangeListener(mListener);

                /*
                 * if (mOnCheckedChangeListener != null) { mSwitchView
