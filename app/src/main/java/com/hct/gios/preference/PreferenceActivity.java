...
import com.hct.gios.widget.ListActivityHCT;
 ...
 * themselves.
 */
public abstract class PreferenceActivity extends ListActivityHCT implements
     ...
     * <p/>
     * Starting from Key Lime Pie, when this argument is passed in, the
     * PreferenceActivity will call isValidFragment() to confirm that the
     * fragment class name is valid for this activity.
     */
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        public HeaderAdapter(Context context, List<Header> objects,
                int layoutResId, boolean removeIconBehavior) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Theming for the PreferenceActivity layout and for the Preference
        // Header(s) layout
        TypedArray sa = obtainStyledAttributes(null,
                R.styleable.PreferenceActivity, R.attr.preferenceActivityStyle,
                0);

        final int layoutResId = sa.getResourceId(
                android.R.styleable.PreferenceActivity_layout,
        ...
        mPreferenceHeaderRemoveEmptyIcon = sa.getBoolean(
                R.styleable.PreferenceActivity_headerRemoveIconIfEmpty, false);
    ...
    public Header onGetInitialHeader() {
        ...
        throw new IllegalStateException(
                "Must have at least one header with a fragment");
    }
        ...
        try {
            ...
            while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("header".equals(nodeName)) {
                    ...
                    TypedArray sa = obtainStyledAttributes(attrs,
                            R.styleable.PreferenceHeader);
                    header.id = sa.getResourceId(
                            android.R.styleable.PreferenceHeader_id,
                            (int) HEADER_ID_UNDEFINED);
                    TypedValue tv = sa
                            .peekValue(android.R.styleable.PreferenceHeader_title);
                    ...
                    tv = sa.peekValue(android.R.styleable.PreferenceHeader_summary);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(android.R.styleable.PreferenceHeader_breadCrumbTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(android.R.styleable.PreferenceHeader_breadCrumbShortTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    header.fragment = sa
                            .getString(android.R.styleable.PreferenceHeader_fragment);
                    sa.recycle();
     ...
     * is a valid type to be attached to this activity. The default
     * implementation returns <code>true</code> for apps built for
     * <code>android:targetSdkVersion</code> older than
     * {@link android.os.Build.VERSION_CODES#KITKAT}. For later versions, it
     * will throw an exception.
     * 
     * @param fragmentName
     *            the class name of the Fragment about to be attached to this
     *            activity.
     * @return true if the fragment class name is valid for this Activity and
     *         false otherwise.
     */
        ...
        if (getApplicationInfo().targetSdkVersion >= android.os.Build.VERSION_CODES.KITKAT) {
            throw new RuntimeException(
                    "Subclasses of PreferenceActivity must override isValidFragment(String)"
                            ...
                            + " has not checked if fragment " + fragmentName
                            + " is valid.");
        } else {
            return true;
        }
     ...
     *            report the result.
     * @param titleRes
     *            Resource ID of string to display for the title of this set of
     *            preferences.
     * @param shortTitleRes
     *            Resource ID of string to display for the short title of this
     *            set of preferences.
     */
    public void startWithFragment(String fragmentName, Bundle args,
    ...
    public void switchToHeader(Header header) {
        if (mCurHeader == header) {
            ...
            if (header.fragment == null) {
                throw new IllegalStateException(
                        "can't switch to header that has no fragment");
            }
