...
public class SeekBarPreference extends Preference implements
    ...
    public SeekBarPreference(Context context, AttributeSet attrs,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                android.R.styleable.ProgressBar, defStyleAttr, defStyleRes);
        ...
        final int layoutResId = a.getResourceId(
                android.R.styleable.SeekBarPreference_layout,
        ...
        mColor = a
                .getColor(R.styleable.SeekBarPreference_android_color, mColor);
        a.recycle();
    ...
    protected void onBindView(View view) {
        ...
        SeekBarHCT seekBar = (SeekBarHCT) view.findViewById(R.id.seekbar);
