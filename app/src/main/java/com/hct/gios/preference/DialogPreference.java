...
public abstract class DialogPreference extends Preference implements
    ...
    public DialogPreference(Context context, AttributeSet attrs,
        ...
        mDialogTitle = a
                .getString(android.R.styleable.DialogPreference_dialogTitle);
        ...
        mDialogMessage = a
                .getString(android.R.styleable.DialogPreference_dialogMessage);
        mDialogIcon = a
                .getDrawable(android.R.styleable.DialogPreference_dialogIcon);
        mPositiveButtonText = a
                .getString(android.R.styleable.DialogPreference_positiveButtonText);
        mNegativeButtonText = a
                .getString(android.R.styleable.DialogPreference_negativeButtonText);
