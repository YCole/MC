...
/**
 * @hide A {@link Preference} that displays a list of entries as a dialog which
 *       allow the user to toggle each individually on and off.
 * 
...
public class MultiCheckPreference extends DialogPreference {
    ...
    public MultiCheckPreference(Context context, AttributeSet attrs,
        ...
        setEntryValuesCS(a
                .getTextArray(android.R.styleable.ListPreference_entryValues));
        a.recycle();

        /*
         * Retrieve the Preference summary attribute since it's private in the
         * Preference class.
         */
     ...
     * {@linkplain java.lang.String#format String formatting} marker in it (i.e.
    ...
    /**
     * Sets the summary for this Preference with a CharSequence. If the summary
     * has a {@linkplain java.lang.String#format String formatting} marker in it
     * (i.e. "%s" or "%1$s"), then the current entry value will be substituted
