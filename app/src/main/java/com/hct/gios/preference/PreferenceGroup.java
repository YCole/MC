...
/**
 * A container for multiple {@link Preference} objects. It is a base class for
 * Preference objects that are parents, such as {@link PreferenceCategory} and
...
public abstract class PreferenceGroup extends Preference implements
    ...
    public PreferenceGroup(Context context, AttributeSet attrs,
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.PreferenceGroup, defStyleAttr, defStyleRes);
        mOrderingAsAdded = a.getBoolean(
                android.R.styleable.PreferenceGroup_orderingFromXml,
                mOrderingAsAdded);
        a.recycle();
    }
     ...
     * 
     * @return Whether this group orders based on the order the children are
     *         added.
    ...
    public boolean addPreference(Preference preference) {
        ...
        if (preference.getOrder() == Preference.DEFAULT_ORDER) {
            ...
            if (preference instanceof PreferenceGroup) {
                ...
                // so we won't end up properly passing this flag down to
                // children
