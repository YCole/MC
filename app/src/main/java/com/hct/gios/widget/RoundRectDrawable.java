...
import static com.hct.gios.widget.RoundRectDrawableWithShadow.calculateVerticalPadding;
import static com.hct.gios.widget.RoundRectDrawableWithShadow.calculateHorizontalPadding;

/**
 * Very simple drawable that draws a rounded rectangle background with arbitrary
 * corners and also reports proper outline for L.
 * <p>
 * Simpler and uses less resources compared to GradientDrawable or
 * ShapeDrawable.
 */
