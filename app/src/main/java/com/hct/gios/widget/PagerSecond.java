...
public class PagerSecond extends HorizontalScrollView {
    ...
    private int underlineColor = 0xFFF4F4F4;// background color
    private int dividerColor = 0x1A000000;

    private boolean shouldExpand = false;
    private boolean textAllCaps = false;

    private int scrollOffset = 43;
    private int indicatorHeight = 2; // 2 dp
    ...
    private int tabTextColorFc = 0xCC000000;
    ...
    public PagerSecond(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSecond(Context context, AttributeSet attrs, int defStyle) {
         ...
         * 
         * tabTextSize = a.getDimensionPixelSize(0, tabTextSize); tabTextColor =
         * a.getColor(1, tabTextColor);
         * 
         * a.recycle();
         */
        // get custom attrs
        ...
        indicatorColor = context.getResources().getColor(
                R.color.gos_common_actb_ab);
        indicatorColor = a.getColor(
                R.styleable.PagerSlidingTabStrip_pstsIndicatorColor,
                indicatorColor);
        underlineColor = context.getResources().getColor(
                R.color.gos_common_actb);
        tabTextColorFc = context.getResources().getColor(
                R.color.gos_common_actb_txt_fc);
        tabTextColor = context.getResources().getColor(
                R.color.gos_common_actb_txt);
    ...
    private void addTab(final int position, View tab) {
        ...
        if (tab instanceof TextView) {
            if (position == 0) {
                // ((TextView) tab).setTextColor(0xe1000000);//set text color
                ((TextView) tab).setTextColor(getResources().getColor(
                        R.color.gos_common_actb_txt_fc));// set text color
                ((TextView) tab).setTypeface(null, Typeface.NORMAL);// set text
                                                                    // type
            } else {
                // ((TextView) tab).setTextColor(0xb2000000);//set text color
                ((TextView) tab).setTextColor(getResources().getColor(
                        R.color.gos_common_actb_txt));// set text color
                ((TextView) tab).setTypeface(null, Typeface.NORMAL);// set text
                                                                    // type
            }
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (currentPosition == i) {
                    ...
                    tab.setTextColor(tabTextColorFc);
                    // tab.setTextColor(0xe1000000);
                } else {
                    tab.setTextSize(14);
                    tab.setTypeface(null, Typeface.NORMAL);
                    tab.setTextColor(tabTextColor);
                    // tab.setTextColor(0xb2000000);
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /*
         * for (int i = 0; i < tabCount - 1; i++) { View tab =
         * tabsContainer.getChildAt(i); canvas.drawLine(tab.getRight(),
         * dividerPadding, tab.getRight(), height - dividerPadding,
         * dividerPaint); }
         */
    }
    ...
    public void setTextColor(int textColor1, int textColor2) {
        this.tabTextColor = textColor1;
        this.tabTextColorFc = textColor2;
        updateTabStyles();
    }
