 ...
 */
@Widget
public class DatePickerHCT extends FrameLayout {
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(DatePickerHCT view, int year, int monthOfYear,
                int dayOfMonth);
    }

    public DatePickerHCT(Context context) {
        this(context, null);
    }

    public DatePickerHCT(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.datePickerStyle);
    }

    public DatePickerHCT(Context context, AttributeSet attrs, int defStyle) {
        ...
        int layoutResourceId = R.layout.date_picker_hct;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(layoutResourceId, this, true);

        OnValueChangeListener onChangeListener = new NumberPickerHCT.OnValueChangeListener() {
        ...
        mDaySpinner.setColor(mUPdownWhellPaintColor, mSelectorWhellPaintColor);
        ...
        mMonthSpinner
                .setColor(mUPdownWhellPaintColor, mSelectorWhellPaintColor);
        ...
        mYearSpinner.setColor(mUPdownWhellPaintColor, mSelectorWhellPaintColor);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DatePickerHCT.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(DatePickerHCT.class.getName());
    }
