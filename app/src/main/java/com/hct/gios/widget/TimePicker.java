...
public class TimePicker extends FrameLayout {
    ...
    /**
     * A delegate interface that defined the public API of the TimePicker.
     * Allows different TimePicker implementations. This would need to be
     * implemented by the TimePicker delegates for the real behavior.
     */
    ...
    /**
     * A callback interface for updating input validity when the TimePicker when
     * included into a Dialog.
     * 
     * @hide
     */
    ...
    /**
     * An abstract class which can be used as a start for TimePicker
     * implementations
     */
    abstract static class AbstractTimePickerDelegate implements
            TimePickerDelegate {
        // The delegator
