 ...
 */
public class CheckedTextViewMutiHCT extends CheckedTextView /*
                                                             * implements
                                                             * Checkable
                                                             */{
    ...
    public CheckedTextViewMutiHCT(Context context) {
        super(context);
        int color = context.getResources().getColor(R.color.gos_common_cb);
        // setCheckMarkDrawable(getDrawable(color));
    }

    public CheckedTextViewMutiHCT(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private Drawable getDrawable(int color) {
        ...
        BitmapDrawable btdrawable = (BitmapDrawable) getResources()
                .getDrawable(R.drawable.btn_check_to_on_mtrl_015);
