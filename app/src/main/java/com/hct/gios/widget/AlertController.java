...
public class AlertController {
    ...
    public AlertController(Context context, DialogInterface di, Window window) {
        ...
        mAlertDialogLayout = a.getResourceId(R.styleable.AlertDialog_layout,
                R.layout.alert_dialog_hct_light);
    ...
    // add by hct.gengbin
    private void setBottomOnHctTheme() {
        // if(mContext.isHctApp()){
     ...
     * 
     * @param resId
     *            the resource identifier of the drawable to use as the icon, or
     *            0 for no icon
     */
    ...
    /**
     * @param attrId
     *            the attributeId of the theme-specific drawable to resolve the
     *            resourceId for.
     * 
        ...
        if (parent != null && decor != null) {
            decor.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
                ...
                public WindowInsets onApplyWindowInsets(View view,
                        WindowInsets insets) {
                    if (insets.isRound()) {
                        // TODO: Get the padding as a function of the window
                        // size.
                        int roundOffset = mContext.getResources()
                                .getDimensionPixelOffset(
                                        R.dimen.alert_dialog_round_padding);
                        parent.setPadding(roundOffset, roundOffset,
    ...
    private void setupView() {
        final LinearLayout contentPanel = (LinearLayout) mWindow
                .findViewById(R.id.contentPanel);
        setupContent(contentPanel);
        final boolean hasButtons = setupButtons();

        final LinearLayout topPanel = (LinearLayout) mWindow
        ...
        final FrameLayout customPanel = (FrameLayout) mWindow
        ...
        if (hasCustomView) {
            final FrameLayout custom = (FrameLayout) mWindow
                    .findViewById(R.id.custom);
            custom.addView(customView, new LayoutParams(MATCH_PARENT,
                    MATCH_PARENT));
        ...
        setBackground(a, topPanel, contentPanel, customPanel, buttonPanel,
                hasTitle, hasCustomView, hasButtons);
        a.recycle();
    }
    ...
    private boolean setupTitle(LinearLayout topPanel) {
        ...
        if (mCustomTitleView != null) {
            ...
            if (hasTextTitle) {
                ...
                // Hide the title template
                final View titleTemplate = mWindow
                        .findViewById(R.id.title_template);
                titleTemplate.setVisibility(View.GONE);
                mIconView.setVisibility(View.GONE);
    ...
    private void centerButton(Button button) {
        ...
        /*
         * View leftSpacer = mWindow.findViewById(R.id.leftSpacer); if
         * (leftSpacer != null) { leftSpacer.setVisibility(View.VISIBLE); } View
         * rightSpacer = mWindow.findViewById(R.id.rightSpacer); if (rightSpacer
         * != null) { rightSpacer.setVisibility(View.VISIBLE); }
         */
    }

    private void setBackground(TypedArray a, View topPanel, View contentPanel,
            View customPanel, View buttonPanel, boolean hasTitle,
            boolean hasCustomView, boolean hasButtons) {
        int fullDark = 0;
        int topDark = 0;
        int centerDark = 0;
        int bottomDark = 0;
        ...
        if (needsDefaultBackgrounds) {
            fullDark = R.drawable.dialog_full_hct_light;
            topDark = R.drawable.dialog_top_hct_light;
            centerDark = R.drawable.dialog_middle_hct_light;
            bottomDark = R.drawable.dialog_bottom_hct_light;
            fullBright = R.drawable.dialog_full_hct_light;
            topBright = R.drawable.dialog_top_hct_light;
            centerBright = R.drawable.dialog_middle_hct_light;
            bottomBright = R.drawable.dialog_bottom_hct_light;
            bottomMedium = R.drawable.dialog_middle_hct_light;
        }

        topBright = a.getResourceId(R.styleable.AlertDialog_topBright,
                topBright);
        topDark = a.getResourceId(R.styleable.AlertDialog_topDark, topDark);
        centerBright = a.getResourceId(R.styleable.AlertDialog_centerBright,
                centerBright);
        centerDark = a.getResourceId(R.styleable.AlertDialog_centerDark,
                centerDark);
        ...
        if (lastView != null) {
            if (setView) {
                bottomBright = a.getResourceId(
                        R.styleable.AlertDialog_bottomBright, bottomBright);
                bottomMedium = a.getResourceId(
                        R.styleable.AlertDialog_bottomMedium, bottomMedium);
                bottomDark = a.getResourceId(
                        R.styleable.AlertDialog_bottomDark, bottomDark);
                ...
                fullBright = a.getResourceId(
                        R.styleable.AlertDialog_fullBright, fullBright);
                fullDark = a.getResourceId(R.styleable.AlertDialog_fullDark,
                        fullDark);
    ...
    private static class CheckedItemAdapter extends ArrayAdapter<CharSequence> {
        public CheckedItemAdapter(Context context, int resource,
