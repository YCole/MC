 ...
 */
class SimpleMonthAdapter extends BaseAdapter implements
    ...
    @Override
    public int getCount() {
        final int diffYear = mController.getMaxYear()
                - mController.getMinYear();
        final int diffMonth = 1 + mController.getMaxMonth()
                - mController.getMinMonth() + 12 * diffYear;
        return diffMonth;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mController.getMinMonth() == month
        ...
        if (mController.getMaxMonth() == month
                && mController.getMaxYear() == year) {
        ...
        v.setMonthParams(selectedDay, month, year,
                mController.getFirstDayOfWeek(), enabledDayRangeStart,
                enabledDayRangeEnd);
        v.invalidate();
    ...
    private boolean isSelectedDayInMonth(int year, int month) {
        return mSelectedDay.get(Calendar.YEAR) == year
                && mSelectedDay.get(Calendar.MONTH) == month;
    }
    ...
    protected void onDayTapped(Calendar day) {
        ...
        mController.onDayOfMonthSelected(day.get(Calendar.YEAR),
