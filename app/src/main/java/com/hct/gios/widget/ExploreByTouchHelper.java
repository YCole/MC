 ...
 * support in custom {@link android.view.View}s that represent a collection of
 * View-like logical items. It extends
 * {@link android.view.accessibility.AccessibilityNodeProvider} and simplifies
 * many aspects of providing information to accessibility services and managing
 * accessibility focus. This class does not currently support hierarchies of
 * logical items.
 * <p>
...
public abstract class ExploreByTouchHelper extends View.AccessibilityDelegate {
    ...
    public ExploreByTouchHelper(View forView) {
        ...
        mManager = (AccessibilityManager) mContext
                .getSystemService(Context.ACCESSIBILITY_SERVICE);
    }

    /**
     * Returns the {@link android.view.accessibility.AccessibilityNodeProvider}
     * for this helper.
     * 
     * @param host
     *            View whose logical children are exposed by this helper.
    ...
    /**
     * Dispatches hover {@link android.view.MotionEvent}s to the virtual view
     * hierarchy when the Explore by Touch feature is enabled.
     * <p>
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_HOVER_ENTER:
            final int virtualViewId = getVirtualViewAt(event.getX(),
                    event.getY());
     ...
     * 
     * @param virtualViewId
     *            The virtual view id for which to send an event.
     * @param eventType
     ...
     * 
     * @param virtualViewId
     *            The virtual view id to invalidate.
     */
     ...
     * 
     * @return A virtual view id, or {@link #INVALID_ID} if no item is currently
     *         focused.
     */
     ...
     * 
     * @param virtualViewId
     *            The virtual view id for the item currently being hovered, or
     *            {@link #INVALID_ID} if no item is hovered within the parent
     *            view.
     */
    private void updateHoveredVirtualView(int virtualViewId) {
        ...
        sendEventForVirtualView(previousVirtualViewId,
     ...
     * 
     * @param virtualViewId
     *            The virtual view id for the item for which to construct an
     *            event.
     * @param eventType
     ...
     *         the specified item.
     */
    private AccessibilityEvent createEventForChild(int virtualViewId,
            int eventType) {
        final AccessibilityEvent event = AccessibilityEvent.obtain(eventType);
     ...
     * {@link android.view.accessibility.AccessibilityNodeInfo} for the
     * specified virtual view id, which includes the host view (
     * {@link View#NO_ID}).
     * 
     * @param virtualViewId
     *            The virtual view id for the item for which to construct a
     *            node.
     * @return An {@link android.view.accessibility.AccessibilityNodeInfo}
     *         populated with information about the specified item.
     */
    ...
    /**
     * Constructs and returns an {@link AccessibilityNodeInfo} for the host view
     * populated with its virtual descendants.
     * 
    ...
    /**
     * Constructs and returns an {@link AccessibilityNodeInfo} for the specified
     * item. Automatically manages accessibility focus actions.
     * <p>
     ...
     * rectangle specified by {@link AccessibilityNodeInfo#getBoundsInParent} to
     * automatically update the following properties:
     * <ul>
     * <li>{@link AccessibilityNodeInfo#setVisibleToUser}
     ...
     * 
     * @param virtualViewId
     *            The virtual view id for item for which to construct a node.
    ...
    private boolean performAction(int virtualViewId, int action,
            Bundle arguments) {
        switch (virtualViewId) {
        case View.NO_ID:
    ...
    private boolean performActionForChild(int virtualViewId, int action,
            Bundle arguments) {
        switch (action) {
        ...
        default:
            return onPerformActionForVirtualView(virtualViewId, action,
                    arguments);
        }
    }
     ...
     * 
     * @param virtualViewId
     *            The id of the virtual view on which to place accessibility
     *            focus.
     * @return Whether this virtual view actually took accessibility focus.
     */
    private boolean requestAccessibilityFocus(int virtualViewId) {
        final AccessibilityManager accessibilityManager = (AccessibilityManager) mContext
                .getSystemService(Context.ACCESSIBILITY_SERVICE);
     ...
     * 
     * @param virtualViewId
     *            The id of the virtual view from which to clear accessibility
     *            focus.
     ...
     * @return virtual view identifier for the logical item under coordinates
     *         (x,y)
     */
     ...
     * </ul>
     * <p>
     * The following required fields are automatically populated by the helper
     * class and may not be overridden:
     * <ul>
     * <li>package name, set to the package of the host view's {@link Context},
     * see {@link AccessibilityEvent#setPackageName}
     * <li>event source, set to the host view and virtual view identifier, see
     * {@link AccessibilityRecord#setSource(View, int)}
     * </ul>
     * 
     * @param virtualViewId
     *            The virtual view id for the item for which to populate the
     *            event
     * @param event
     ...
     * <li>bounds in screen coordinates, computed based on host view bounds, see
     * {@link AccessibilityNodeInfo#setBoundsInScreen}
     * </ul>
     * <p>
     * Additionally, the helper class automatically handles accessibility focus
     * management by adding the appropriate
     * {@link AccessibilityNodeInfo#ACTION_ACCESSIBILITY_FOCUS} or
     * {@link AccessibilityNodeInfo#ACTION_CLEAR_ACCESSIBILITY_FOCUS} action.
     * Implementations must <b>never</b> manually add these actions.
     * <p>
     * The helper class also automatically modifies parent- and screen-relative
     * bounds to reflect the portion of the item visible within its parent.
     * 
     * @param virtualViewId
     *            The virtual view identifier of the item for which to populate
     *            the node
     * @param node
    ...
    /**
     * Performs the specified accessibility action on the item associated with
     * the virtual view identifier. See
     * {@link AccessibilityNodeInfo#performAction(int, Bundle)} for more
     * information.
     * <p>
     ...
     * {@link AccessibilityNodeInfo#ACTION_ACCESSIBILITY_FOCUS} and
     * {@link AccessibilityNodeInfo#ACTION_CLEAR_ACCESSIBILITY_FOCUS} actions.
     * 
     * @param virtualViewId
     *            The virtual view identifier of the item on which to perform
     *            the action
     * @param action
    ...
    private class ExploreByTouchNodeProvider extends AccessibilityNodeProvider {
        ...
        public boolean performAction(int virtualViewId, int action,
                Bundle arguments) {
            return ExploreByTouchHelper.this.performAction(virtualViewId,
                    action, arguments);
        }
    }
}
