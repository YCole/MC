...
public class DatePicker extends FrameLayout {
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        final int mode = a.getInt(R.styleable.DatePicker_datePickerMode,
                MODE_SPINNER);
        final int firstDayOfWeek = a.getInt(
                R.styleable.DatePicker_firstDayOfWeek, 0);
        a.recycle();

        switch (mode) {
        case MODE_CALENDAR:
            mDelegate = createCalendarUIDelegate(context, attrs, defStyleAttr,
                    defStyleRes);
            break;
        case MODE_SPINNER:
        default:
            mDelegate = createSpinnerUIDelegate(context, attrs, defStyleAttr,
                    defStyleRes);
            break;
        }
    ...
    private DatePickerDelegate createSpinnerUIDelegate(Context context,
            AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        return new DatePickerSpinnerDelegate(this, context, attrs,
                defStyleAttr, defStyleRes);
    }

    private DatePickerDelegate createCalendarUIDelegate(Context context,
            AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    /**
     * A delegate interface that defined the public API of the DatePicker.
     * Allows different DatePicker implementations. This would need to be
     * implemented by the DatePicker delegates for the real behavior.
     * 
     * @hide
     */
    ...
    /**
     * An abstract class which can be used as a start for DatePicker
     * implementations
     */
    abstract static class AbstractDatePickerDelegate implements
            DatePickerDelegate {
        // The delegator
     ...
     */
    private static class DatePickerSpinnerDelegate extends
        ...
        DatePickerSpinnerDelegate(DatePicker delegator, Context context,
            ...
            boolean spinnersShown = attributesArray.getBoolean(
                    R.styleable.DatePicker_spinnersShown,
            ...
            int endYear = attributesArray.getInt(
                    R.styleable.DatePicker_endYear, DEFAULT_END_YEAR);
            ...
            int layoutResourceId = attributesArray.getResourceId(
                    R.styleable.DatePicker_legacyLayout,
            ...
            OnValueChangeListener onChangeListener = new OnValueChangeListener() {
                public void onValueChange(NumberPicker picker, int oldVal,
                    ...
                    // take care of wrapping of days and months to update
                    // greater fields
                    if (picker == mDaySpinner) {
                        ...
                        if (oldVal == maxDayOfMonth && newVal == 1) {
                            ...
                            mTempDate.add(Calendar.DAY_OF_MONTH, newVal
                                    - oldVal);
                        }
            ...
            mCalendarView = (CalendarView) mDelegator
        ...
        protected void setCurrentLocale(Locale locale) {
            ...
            if (usingNumericMonths()) {
                // We're in a locale where a date should either be all-numeric,
                // or all-text.
                // All-text would require custom NumberPicker formatters for day
                // and year.
        ...
        /**
         * Reorders the spinners according to the date format that is explicitly
         * set by the user and if no such is set fall back to the current
        ...
        private void reorderSpinners() {
            ...
            // icu4c what
            // order the user's locale uses for that combination.
            // http://b/7207103.
         ...
         * result to the <code>outDate</code>.
         * 
        ...
        private boolean parseDate(String date, Calendar outDate) {
            try {
                ...
                Log.w(LOG_TAG, "Date: " + date + " not in format: "
                        + DATE_FORMAT);
                return false;
            }
        }
        ...
        private void updateSpinners() {
            ...
            if (mCurrentDate.equals(mMinDate)) {
                mDaySpinner
                        .setMinValue(mCurrentDate.get(Calendar.DAY_OF_MONTH));
                ...
                mDaySpinner
                        .setMaxValue(mCurrentDate.get(Calendar.DAY_OF_MONTH));
                mDaySpinner.setWrapSelectorWheel(false);
                mMonthSpinner.setDisplayedValues(null);
        ...
        private void notifyDateChanged() {
            ...
            if (mOnDateChangedListener != null) {
                mOnDateChangedListener.onDateChanged(mDelegator, getYear(),
        ...
        private void updateInputState() {
            // Make sure that if the user changes the value and the IME is
            // active
            // for one of the inputs if this widget, the IME is closed. If the
            // user
            // changed the value via the IME and there is a next input the IME
            // will
