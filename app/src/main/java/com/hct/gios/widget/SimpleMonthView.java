...
class SimpleMonthView extends View {
    ...
    private SimpleDateFormat mDayFormatter = new SimpleDateFormat("EEEEE",
            Locale.getDefault());
    ...
    public SimpleMonthView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMiniDayNumberTextSize = res
                .getDimensionPixelSize(R.dimen.datepicker_day_number_size);
        mMonthLabelTextSize = res
                .getDimensionPixelSize(R.dimen.datepicker_month_label_size);
        mMonthDayLabelTextSize = res
                .getDimensionPixelSize(R.dimen.datepicker_month_day_label_text_size);
        mMonthHeaderSize = res
                .getDimensionPixelOffset(R.dimen.datepicker_month_list_item_header_height);
        mDaySelectedCircleSize = res
                .getDimensionPixelSize(R.dimen.datepicker_day_number_select_circle_radius);

        mRowHeight = (res
                .getDimensionPixelOffset(R.dimen.datepicker_view_animator_height) - mMonthHeaderSize)
                / MAX_NUM_ROWS;
    ...
    /**
     * Sets all the parameters for displaying this week. Parameters have a
     * default value and will only update if a new value is included, except for
     * focus month, which will always default to no focus month if no value is
     * passed in. The only required parameter is the week start.
     * 
     * @param selectedDay
     ...
     *            the year.
     * @param weekStart
     *            which day the week should start on. {@link Calendar#SUNDAY}
    ...
    private void drawWeekDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < mNumDays; i++) {
            ...
            final String dayLabel = mDayFormatter.format(mDayLabelCalendar
                    .getTime());
    ...
    private void drawDays(Canvas canvas) {
        ...
        for (int day = 1; day <= mNumCells; day++) {
            ...
            if (mSelectedDay == day) {
                canvas.drawCircle(x, y - (mMiniDayNumberTextSize / 3),
                        mDaySelectedCircleSize, mDayNumberSelectedPaint);
            }
    ...
    private void onDayClick(int day) {
        ...
        mTouchHelper.sendEventForVirtualView(day,
    ...
    boolean restoreAccessibilityFocus(Calendar day) {
        if ((day.get(Calendar.YEAR) != mYear)
    ...
    private class MonthViewTouchHelper extends ExploreByTouchHelper {
        ...
        public void clearFocusedVirtualView() {
            ...
            if (focusedVirtualView != ExploreByTouchHelper.INVALID_ID) {
                getAccessibilityNodeProvider(SimpleMonthView.this)
                        .performAction(
                                focusedVirtualView,
