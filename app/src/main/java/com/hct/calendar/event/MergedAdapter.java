...
public class MergedAdapter<T extends ListAdapter> extends BaseAdapter {
    ...
    /**
     * For a given merged position, find the corresponding Adapter and local
     * position within that Adapter by iterating through Adapters and summing
     * their counts until the merged position is found.
     * 
     * @param position
     *            a merged (global) position
    ...
    public int getItemViewType(int position) {
        ...
        // Headers (negative types) are in a separate global namespace and their
        // values should not
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        LocalAdapterPosition<T> result = getAdapterOffsetForItem(position);
        return result.mAdapter.getView(result.mLocalPosition, convertView,
                parent);
    }
    ...
    public boolean isEnabled(int position) {
        LocalAdapterPosition<T> result = getAdapterOffsetForItem(position);
        return result == null ? false : result.mAdapter
                .isEnabled(result.mLocalPosition);
    }
