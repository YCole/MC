...
public class WheelView extends View {
    ...
    private static final int ITEMS_TEXT_COLOR = 0xE6000000;
    ...
    private void initData(Context context) {
        ...
        if (typedArray != null) {
            widthProportion = typedArray.getFloat(
                    R.styleable.wheelview_widthProportion, 0);
            typedArray.recycle();
        }
    }
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            int px = DensityUtils.dp2px(mContext, 13);
            itemsPaint.setTextSize(px);
            itemsPaint.setColor(Color.parseColor("#F0F0F0"));
        }
        ...
        if (valuePaint == null) {
            ...
            int px = DensityUtils.dp2px(mContext, 15);
            valuePaint.setTextSize(px);
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        if (maxLength > 0) {
            ...
            itemsWidth = (int) (widthProportion * mScreenWidth * 0.8);
        } else {
            itemsWidth = 0;
        }
    ...
    private void drawItems(Canvas canvas) {
        ...
        itemsPaint.setColor(Color.parseColor("#D0D0D0"));
