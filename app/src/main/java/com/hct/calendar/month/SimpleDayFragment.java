 ...
 * </p>
 */
public class SimpleDayFragment extends Fragment implements OnScrollListener,
    ...
    protected MonthViewPagerAdapter mAdapter;
    ...
    protected boolean mIsOnResumeGoTo = false;
    ...
    protected DataSetObserver mObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            if (day.year != mSelectedDay.year
                    || day.yearDay != mSelectedDay.yearDay) {
                goTo(day.toMillis(true), true, true, false);
            }
        }
    };

    public SimpleDayFragment(long initialTime, String initTimeZone) {
        mSelectedDay.switchTimezone(initTimeZone);
        mTempTime.switchTimezone(initTimeZone);
        // goTo(initialTime, false, true, false);
    ...
    public void onAttach(Activity activity) {
        ...
        mSaturdayColor = res.getColor(R.color.cale_subtitle_color);
        mSundayColor = res.getColor(R.color.cale_subtitle_color);
        mDayNameColor = res.getColor(R.color.color06_transparency10);
    ...
    protected void setViewPagerAdapter(MonthViewPagerAdapter a) {
    ...
    protected void setUpAdapter() {
        ...
        weekParams.put(SimpleWeeksAdapter.WEEK_PARAMS_JULIAN_DAY,
                Time.getJulianDay(mSelectedDay.toMillis(false),
                        mSelectedDay.gmtoff));
        if (mAdapter == null) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null
                && savedInstanceState.containsKey(KEY_CURRENT_TIME)) {
            goTo(savedInstanceState.getLong(KEY_CURRENT_TIME), false, true,
                    true);
        }
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mViewPager = (ViewPager) getView().findViewById(R.id.month_view_pager);
        setUpViewPager();
        setUpHeader();
    ...
    protected SimpleWeekView getFirstGridItem() {
        GridView gv = mAdapter.getPrimaryItem();
        return gv == null ? null : (SimpleWeekView) gv.getChildAt(0);
    }
    ...
    protected void setUpHeader() {
        ...
        for (int i = Calendar.SUNDAY; i <= Calendar.SATURDAY; i++) {
            ...
            Log.d("liaozhenbin", "SimpleDayFragment labels: "
                    + mDayLabels[i - Calendar.SUNDAY]);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.hct_month_by_week, container, false);
     ...
     * selected time. com.hct.calendar.month.SimpleDayFragment.getSelectedTime()
     * 
     * @return
     */
     ...
     */
    public boolean goTo(long time, boolean animate, boolean setSelected,
            boolean forceScroll) {
        return false;
    }
     ...
     */
    private void updateMonthHighlight(SimpleWeekView child) {
        if (child == null) {
            return;
        }
    ...
    public void onPageSelected(int postion) {
        /*
         * GridView gvv = (GridView) mViewPager.findViewWithTag(postion);
         * SimpleWeekView child = (SimpleWeekView)
         * (gvv==null?null:gvv.getChildAt(0)); if(child==null){ return; }
         * mFirstVisibleDay.setJulianDay(child.getFirstJulianDay());
         * updateMonthHighlight(child);
         */
    }
