...
public class ICalendar {
    ...
    public static class Component {
        ...
        private final LinkedHashMap<String, ArrayList<Property>> mPropsMap = new LinkedHashMap<String, ArrayList<Property>>();
        ...
        public void addProperty(Property prop) {
            ...
            Log.i("lwt", "ICalendar addProperty name" + name);
            ArrayList<Property> props = mPropsMap.get(name);
            Log.i("lwt", "ICalendar addProperty props" + props);
            if (props == null) {
        ...
        /**
         * Returns a list of properties with the specified name. Returns null if
        ...
        /**
         * Returns the first property with the specified name. Returns null if
        ...
        public List<Property> getPropertiesInComponent(String strComponentName,
                String PropertyName) {
            List<Property> PropertyReturn = null;
            if (mName.equals(strComponentName)) {
                PropertyReturn = getProperties(PropertyName);
            } else if (null != mChildren) {
                for (Component cp : mChildren) {
                    PropertyReturn = cp.getPropertiesInComponent(
                            strComponentName, PropertyName);
        ...
        public Property getFirstPropertyInComponent(String strComponentName,
                String PropertyName) {
            Property PropertyReturn = null;
            if (mName.equals(strComponentName)) {
                PropertyReturn = getFirstProperty(PropertyName);
            } else if (null != mChildren) {
                for (Component cp : mChildren) {
                    PropertyReturn = cp.getFirstPropertyInComponent(
                            strComponentName, PropertyName);
                    if (null != PropertyReturn) {
                        break;
                    }
        ...
        public String getFirstPropertyValueInComponent(String strComponentName,
                String PropertyName) {
            Property property = getFirstPropertyInComponent(strComponentName,
                    PropertyName);
    ...
    public static class Property {
        ...
        private final String mName;
        private LinkedHashMap<String, ArrayList<Parameter>> mParamsMap = new LinkedHashMap<String, ArrayList<Parameter>>();
        ...
        /**
         * Returns the first parameter with the specified name. May return nll
    ...
    /**
     * Parses a line into the provided component. Creates a new component if the
    ...
    private static Component parseLine(String line, ParserState state,
            Component component) throws FormatException {
     ...
     * @throws FormatException
     *             Thrown if the text could not be parsed into an iCalendar
     *             VCALENDAR object.
     */
    ...
    /**
     * Parses the provided text into an iCalendar event. The top-level component
     * must be of type VEVENT.
     * 
     * @param text
     *            The text to be parsed.
     ...
     * 
     * @param component
     *            The component to which the parsed iCalendar data should be
     *            added.
     * @param text
     *            The text to be parsed.
     * @return The top-level component.
     * @throws FormatException
     *             Thrown if the text could not be parsed as an iCalendar
     *             object.
     */
