...
public final class PermissionUtils {
    ...
    public abstract static class RationaleHandler {
        ...
        void showRationale(Context context, int requestCode,
                String[] permissions) {
    ...
    private static String[] getDeniedPermissions(final Context context,
