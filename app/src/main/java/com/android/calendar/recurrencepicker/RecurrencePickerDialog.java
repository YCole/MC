...
public class RecurrencePickerDialog extends DialogFragment implements
    ...
    private class RecurrenceModel implements Parcelable {
        ...
        public String toString() {
            return "Model [freq=" + freq + ", interval=" + interval + ", end="
                    + end + ", endDate=" + endDate + ", endCount=" + endCount
                    + ", weeklyByDayOfWeek="
                    + Arrays.toString(weeklyByDayOfWeek) + ", monthlyRepeat="
                    + monthlyRepeat + ", monthlyByMonthDay="
                    + monthlyByMonthDay + ", monthlyByDayOfWeek="
                    + monthlyByDayOfWeek + ", monthlyByNthDayOfWeek="
    ...
    private ArrayList<CharSequence> mEndSpinnerArray = new ArrayList<CharSequence>(
            3);
    ...
    private RadioButtonHCT mRepeatMonthlyByNthDayOfWeek;
    private RadioButtonHCT mRepeatMonthlyByNthDayOfMonth;
    ...
    static public boolean isSupportedMonthlyByNthDayOfWeek(int num) {
        ...
        return (num > 0 && num <= FIFTH_WEEK_IN_A_MONTH)
                || num == LAST_NTH_DAY_OF_WEEK;
    }
    ...
    static private void copyEventRecurrenceToModel(final EventRecurrence er,
        ...
        if (!TextUtils.isEmpty(er.until)) {
            ...
            if (model.end == RecurrenceModel.END_BY_COUNT
                    && model.endDate != null) {
                throw new IllegalStateException("freq=" + er.freq);
            }
    ...
    static private void copyModelToEventRecurrence(final RecurrenceModel model,
        ...
        case RecurrenceModel.FREQ_MONTHLY:
            if (model.monthlyRepeat == RecurrenceModel.MONTHLY_BY_DATE) {
                ...
                int count = 1;
                if (er.bydayCount < count || er.byday == null
                        || er.bydayNum == null) {
                    er.byday = new int[count];
                    er.bydayNum = new int[count];
                }
                er.bydayCount = count;
                er.byday[0] = EventRecurrence
                        .timeDay2Day(model.monthlyByDayOfWeek);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecurrence.wkst = EventRecurrence.timeDay2Day(Utils
                .getFirstDayOfWeek(getActivity()));

        getDialog().getWindow().requestFeature(Window.FEATURE_NO_TITLE);

        boolean endCountHasFocus = false;
        if (savedInstanceState != null) {
            RecurrenceModel m = (RecurrenceModel) savedInstanceState
                    .get(BUNDLE_MODEL);
            if (m != null) {
                mModel = m;
            }
            endCountHasFocus = savedInstanceState
                    .getBoolean(BUNDLE_END_COUNT_HAS_FOCUS);
        } else {
        ...
        mRepeatSwitch
                .setChecked(mModel.recurrenceState == RecurrenceModel.STATE_RECURRENCE);
        ...
        ArrayAdapter<CharSequence> freqAdapter = ArrayAdapter
                .createFromResource(getActivity(), R.array.recurrence_freq,
        ...
        mInterval.addTextChangedListener(new minMaxTextWatcher(1,
            ...
            void onChange(int v) {
                if (mIntervalResId != -1
                        && mInterval.getText().toString().length() > 0) {
                    mModel.interval = v;
                    updateIntervalText();
        ...
        mIntervalPostText = (TextView) mView
                .findViewById(R.id.intervalPostText);

        mEndNeverStr = mResources
                .getString(R.string.recurrence_end_continously);
        mEndDateLabel = mResources
                .getString(R.string.recurrence_end_date_label);
        mEndCountLabel = mResources
                .getString(R.string.recurrence_end_count_label);
        ...
        mEndSpinnerAdapter = new EndSpinnerAdapter(getActivity(),
                mEndSpinnerArray, R.layout.recurrencepicker_freq_item,
        ...
        mMonthRepeatByDayOfWeekStrs[0] = mResources
                .getStringArray(R.array.repeat_by_nth_sun);
        mMonthRepeatByDayOfWeekStrs[1] = mResources
                .getStringArray(R.array.repeat_by_nth_mon);
        mMonthRepeatByDayOfWeekStrs[2] = mResources
                .getStringArray(R.array.repeat_by_nth_tues);
        mMonthRepeatByDayOfWeekStrs[3] = mResources
                .getStringArray(R.array.repeat_by_nth_wed);
        mMonthRepeatByDayOfWeekStrs[4] = mResources
                .getStringArray(R.array.repeat_by_nth_thurs);
        mMonthRepeatByDayOfWeekStrs[5] = mResources
                .getStringArray(R.array.repeat_by_nth_fri);
        mMonthRepeatByDayOfWeekStrs[6] = mResources
                .getStringArray(R.array.repeat_by_nth_sat);
        ...
        mMonthRepeatByRadioGroup = (RadioGroup) mView
                .findViewById(R.id.monthGroup);
        mMonthRepeatByRadioGroup.setOnCheckedChangeListener(this);
        mRepeatMonthlyByNthDayOfWeek = (RadioButtonHCT) mView
                .findViewById(R.id.repeatMonthlyByNthDayOfTheWeek);
        mRepeatMonthlyByNthDayOfMonth = (RadioButtonHCT) mView
    ...
    public void updateDialog() {
        ...
        mWeekGroup
                .setVisibility(mModel.freq == RecurrenceModel.FREQ_WEEKLY ? View.VISIBLE
                        : View.GONE);
        mWeekGroup2
                .setVisibility(mModel.freq == RecurrenceModel.FREQ_WEEKLY ? View.VISIBLE
                        : View.GONE);
        mMonthGroup
                .setVisibility(mModel.freq == RecurrenceModel.FREQ_MONTHLY ? View.VISIBLE
                        : View.GONE);
        ...
        case RecurrenceModel.FREQ_MONTHLY:
            ...
            if (mModel.monthlyRepeat == RecurrenceModel.MONTHLY_BY_DATE) {
                mMonthRepeatByRadioGroup
                        .check(R.id.repeatMonthlyByNthDayOfMonth);
            } else if (mModel.monthlyRepeat == RecurrenceModel.MONTHLY_BY_NTH_DAY_OF_WEEK) {
                mMonthRepeatByRadioGroup
                        .check(R.id.repeatMonthlyByNthDayOfTheWeek);
            }
            ...
            if (mMonthRepeatByDayOfWeekStr == null) {
                ...
                mRepeatMonthlyByNthDayOfWeek
                        .setText(mMonthRepeatByDayOfWeekStr);
            }
            break;
    ...
    private void updateIntervalText() {
        ...
        if (markerStart != -1) {
            ...
            mIntervalPreText.setText(intervalString.substring(0, markerStart)
                    .trim());
        }
    }
    ...
    private void updateEndCountText() {
        ...
        String endString = mResources.getQuantityString(
                R.plurals.recurrence_end_count, mModel.endCount);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position,
        ...
        if (parent == mFreqSpinner) {
            ...
            mEndCount
                    .setVisibility(mModel.end == RecurrenceModel.END_BY_COUNT ? View.VISIBLE
                            : View.GONE);
            mEndDateTextView
                    .setVisibility(mModel.end == RecurrenceModel.END_BY_DATE ? View.VISIBLE
                            : View.GONE);
            mPostEndCount
                    .setVisibility(mModel.end == RecurrenceModel.END_BY_COUNT
                            && !mHidePostEndCount ? View.VISIBLE : View.GONE);
    ...
    public void onClick(View v) {
        if (mEndDateTextView == v) {
            ...
            mDatePickerDialog = DatePickerDialog.newInstance(this,
                    mModel.endDate.year, mModel.endDate.month,
                    mModel.endDate.monthDay);
            mDatePickerDialog.setFirstDayOfWeek(Utils
                    .getFirstDayOfWeekAsCalendar(getActivity()));
    ...
    private class EndSpinnerAdapter extends ArrayAdapter<CharSequence> {
         ...
         * @param objects
         */
        public EndSpinnerAdapter(Context context,
                ArrayList<CharSequence> strings, int itemResourceId,
                int textResourceId) {
            ...
            mStrings = strings;
            mEndDateString = getResources().getString(
                    R.string.recurrence_end_date);
            ...
            if (mUseFormStrings) {
                ...
                mEndSpinner.setLayoutParams(new TableLayout.LayoutParams(0,
            ...
            case RecurrenceModel.END_BY_DATE:
                ...
                if (markerStart != -1) {
                    if (mUseFormStrings || markerStart == 0) {
                        ...
                        item.setText(mEndDateString.substring(0, markerStart)
                                .trim());
                    }
                }
                break;
            case RecurrenceModel.END_BY_COUNT:
                ...
                if (markerStart != -1) {
                    if (mUseFormStrings || markerStart == 0) {
                        ...
                        int postTextStart = markerStart
                                + END_COUNT_MARKER.length();
                        mPostEndCount.setText(endString.substring(
                                postTextStart, endString.length()).trim());
