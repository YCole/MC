...
public class CalendarEventModel implements Serializable {
    ...
    public static class ReminderEntry implements Comparable<ReminderEntry>,
         ...
         * 
         * @param minutes
         *            Number of minutes before the start of the event that the
         *            alert will fire.
         * @param method
         *            Type of alert ({@link Reminders#METHOD_ALERT}, etc).
         */
        ...
        /**
         * Returns a ReminderEntry, with the specified number of minutes and a
        ...
        public boolean equals(Object obj) {
            ...
            // change anything,
            // the internal conversion of DEFAULT to ALERT doesn't force a
            // database update.
        ...
        /**
         * Comparison function for a sort ordered primarily descending by
         * minutes, secondarily ascending by method type.
         */
        @Override
    ...
    public String mCalendarDisplayName = ""; // Make sure this is in sync with
                                             // the mCalendarId
    ...
    public String mRdate = null;// MF4.1 add
    public String mOrganizer = null;
    public String mOrganizerDisplayName = null;

    // add by hct.gengbin
    public int mEventType = 0;
    public String mActionData = null;
    public String mActionData1 = null;
    public String mActionData2 = null;
    /**
    ...
    // This should be set the same as mStart when created and is used for making
    // changes to
    // recurring events. It should not be updated after it is initially set.
    public long mOriginalStart = -1;
    public long mStart = -1;

    // This should be set the same as mEnd when created and is used for making
    // changes to
    // recurring events. It should not be updated after it is initially set.
    ...
    // PROVIDER_NOTES How does an event not have attendee data? The owner is
    // added
    ...
    // PROVIDER_NOTES Using EditEventHelper the owner should not be included in
    // this
    ...
    public CalendarEventModel(Context context, Intent intent) {
        ...
        String rdate = intent.getStringExtra(Events.RDATE);
    ...
    public void addAttendees(String attendees, Rfc822Validator validator) {
        final LinkedHashSet<Rfc822Token> addresses = EditEventHelper
                .getAddressesFromList(attendees, validator);
        synchronized (this) {
    ...
    public int hashCode() {
        ...
        result = prime
                * result
                + ((mAttendeesList == null) ? 0 : getAttendeesString()
                        .hashCode());
        result = prime * result + (int) (mCalendarId ^ (mCalendarId >>> 32));
        result = prime * result
                + ((mDescription == null) ? 0 : mDescription.hashCode());
        result = prime * result
                + ((mDuration == null) ? 0 : mDuration.hashCode());
        ...
        result = prime * result
                + ((mOrganizer == null) ? 0 : mOrganizer.hashCode());
        result = prime * result
                + ((mOriginalAllDay == null) ? 0 : mOriginalAllDay.hashCode());
        result = prime * result + (int) (mOriginalEnd ^ (mOriginalEnd >>> 32));
        result = prime * result
                + ((mOriginalSyncId == null) ? 0 : mOriginalSyncId.hashCode());
        result = prime * result + (int) (mOriginalId ^ (mOriginalEnd >>> 32));
        result = prime * result
                + (int) (mOriginalStart ^ (mOriginalStart >>> 32));
        result = prime * result
                + ((mOriginalTime == null) ? 0 : mOriginalTime.hashCode());
        result = prime * result
                + ((mOwnerAccount == null) ? 0 : mOwnerAccount.hashCode());
        result = prime * result
                + ((mReminders == null) ? 0 : mReminders.hashCode());
        result = prime * result + ((mRrule == null) ? 0 : mRrule.hashCode());
        result = prime * result + ((mRdate == null) ? 0 : mRdate.hashCode());
        result = prime * result + mSelfAttendeeStatus;
        result = prime * result + mOwnerAttendeeId;
        result = prime * result + (int) (mStart ^ (mStart >>> 32));
        result = prime * result
                + ((mSyncAccount == null) ? 0 : mSyncAccount.hashCode());
        result = prime
                * result
                + ((mSyncAccountType == null) ? 0 : mSyncAccountType.hashCode());
        result = prime * result + ((mSyncId == null) ? 0 : mSyncId.hashCode());
        result = prime * result
                + ((mTimezone == null) ? 0 : mTimezone.hashCode());
        result = prime * result
                + ((mTimezone2 == null) ? 0 : mTimezone2.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (mRdate == null) {
            if (other.mRdate != null) {
                return false;
            }
        } else if (!mRdate.equals(other.mRdate)) {
            return false;
        }
    ...
    public boolean isUnchanged(CalendarEventModel originalModel) {
        ...
        if (TextUtils.isEmpty(mRdate)) {
            // if the rdate is no longer empty check if this is an exception
            if (!TextUtils.isEmpty(originalModel.mRdate)) {
                boolean syncIdNotReferenced = mOriginalSyncId == null
                        || !mOriginalSyncId.equals(originalModel.mSyncId);
                boolean localIdNotReferenced = mOriginalId == -1
                        || !(mOriginalId == originalModel.mId);
        ...
        } else if (!mRdate.equals(originalModel.mRdate)) {
            return false;
        }
    ...
    public int[] getCalendarEventColors() {
        if (mEventColorCache != null) {
            return mEventColorCache.getColorArray(mCalendarAccountName,
    ...
    public int getEventColorKey() {
        if (mEventColorCache != null) {
            return mEventColorCache.getColorKey(mCalendarAccountName,
                    mCalendarAccountType, mEventColor);
        }
        return -1;
    }
}
