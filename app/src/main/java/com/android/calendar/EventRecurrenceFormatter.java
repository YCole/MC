...
public class EventRecurrenceFormatter {
    ...
    public static String getRepeatString(Context context, Resources r,
            EventRecurrence recurrence, boolean includeEndString) {
        String endString = "";
        if (includeEndString) {
        ...
        case EventRecurrence.DAILY:
            return r.getQuantityString(R.plurals.daily, interval, interval)
                    + endString;
        case EventRecurrence.WEEKLY: {
            if (recurrence.repeatsOnEveryWeekDay()) {
                ...
                return r.getQuantityString(R.plurals.weekly, interval,
                        interval, string) + endString;
            }
        }
