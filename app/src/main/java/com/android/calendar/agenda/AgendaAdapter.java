...
public class AgendaAdapter extends ResourceCursorAdapter {
    ...
    /*
     * private int COLOR_CHIP_ALL_DAY_HEIGHT; private int COLOR_CHIP_HEIGHT;
     */
    ...
    public AgendaAdapter(Context context, int resource) {
        ...
        mDeclinedColor = mResources
                .getColor(R.color.agenda_item_declined_color);
        mStandardColor = mResources
                .getColor(R.color.agenda_item_standard_color);
        mWhereDeclinedColor = mResources
        ...
        /*
         * COLOR_CHIP_ALL_DAY_HEIGHT =
         * mResources.getInteger(R.integer.color_chip_all_day_height);
         * COLOR_CHIP_HEIGHT =
         * mResources.getInteger(R.integer.color_chip_height); if (mScale == 0)
         * { mScale = mResources.getDisplayMetrics().density; if (mScale != 1) {
         * COLOR_CHIP_ALL_DAY_HEIGHT *= mScale; COLOR_CHIP_HEIGHT *= mScale; } }
         */
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (holder == null) {
            ...
            holder.textContainer = (LinearLayout) view
                    .findViewById(R.id.agenda_item_text_container);
            holder.selectedMarker = (CheckBoxHCT) view
                    .findViewById(R.id.selected_marker);
            holder.colorChip = (ColorChipView) view
                    .findViewById(R.id.agenda_item_color);
        }

        // HCT_MODIFY lixiange MF3.0 add delete all select event
        if (AgendaFragment.actionModeStarted
                && mSelectedItems.contains(cursor.getPosition())) {
        ...
        if (selfAttendeeStatus == Attendees.ATTENDEE_STATUS_DECLINED) {
            ...
            holder.colorChip.setDrawStyle(ColorChipView.DRAW_CIRCLE);
        } else {
        ...
        /*
         * if (allDay) { params.height = COLOR_CHIP_ALL_DAY_HEIGHT; } else {
        ...
        int canRespond = cursor
                .getInt(AgendaWindowAdapter.INDEX_CAN_ORGANIZER_RESPOND);
        if (canRespond == 0) {
            String owner = cursor
                    .getString(AgendaWindowAdapter.INDEX_OWNER_ACCOUNT);
            String organizer = cursor
                    .getString(AgendaWindowAdapter.INDEX_ORGANIZER);
        ...
        if (!allDay) {
            ...
            whenString = DateUtils.formatDateRange(context, mFormatter, begin,
            ...
            when.setText(R.string.edit_event_all_day_label);
        }
        ...
        // Where
        String whereString = cursor
                .getString(AgendaWindowAdapter.INDEX_EVENT_LOCATION);
