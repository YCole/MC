...
public class DayOfMonthDrawable extends Drawable {
    ...
    private float mTodayOff = 4;

    public DayOfMonthDrawable(Context c) {
        mTextSize = c.getResources().getDimension(R.dimen.today_icon_text_size);
        mTodayOff = c.getResources().getDimension(R.dimen.today_icon_off_size);
        mPaint = new Paint();
        mPaint.setAlpha(255);
        mPaint.setColor(c.getResources().getColor(
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawText(mDayOfMonth, bounds.right / 2, ((float) bounds.bottom
                + textHeight + mTodayOff) / 2, mPaint);
    }
