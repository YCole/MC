...
public class CalendarColorPickerDialog extends ColorPickerDialog {
    ...
    static final String[] COLORS_PROJECTION = new String[] { Colors.COLOR,
            Colors.COLOR_KEY };
    ...
    private class QueryService extends AsyncQueryService {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            case TOKEN_QUERY_CALENDARS:
                ...
                mSelectedColor = Utils.getDisplayColorFromColor(cursor
                        .getInt(CALENDARS_INDEX_CALENDAR_COLOR));
            ...
            case TOKEN_QUERY_COLORS:
                ...
                Integer[] colorsToSort = colors.toArray(new Integer[colors
                        .size()]);
    ...
    private class OnCalendarColorSelectedListener implements
        ...
        public void onColorSelected(int color) {
            ...
            mService.startUpdate(mService.getNextToken(), null, ContentUris
                    .withAppendedId(Calendars.CONTENT_URI, mCalendarId),
    ...
    public static CalendarColorPickerDialog newInstance(long calendarId,
        ...
        ret.setArguments(R.string.calendar_color_picker_dialog_title,
                NUM_COLUMNS, isTablet ? SIZE_LARGE : SIZE_SMALL);
    ...
    public void setColors(int[] colors) {
        throw new IllegalStateException(
                "Must call setCalendarId() to update calendar colors");
    }
    ...
    private void startQuery() {
        if (mService != null) {
            showProgressBarView();
            mService.startQuery(TOKEN_QUERY_CALENDARS, null, ContentUris
                    .withAppendedId(Calendars.CONTENT_URI, mCalendarId),
