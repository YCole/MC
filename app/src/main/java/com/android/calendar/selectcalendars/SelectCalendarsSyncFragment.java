...
public class SelectCalendarsSyncFragment extends ListFragment implements
    ...
    private static final String SORT_ORDER = IS_PRIMARY + " DESC,"
            + Calendars.CALENDAR_DISPLAY_NAME + COLLATE_NOCASE;
        ...
        public void onChange(boolean selfChange) {
            ...
            if (!selfChange) {
                getLoaderManager().initLoader(0, null,
                        SelectCalendarsSyncFragment.this);
            }
        }
    };
    ...
    public void onResume() {
        ...
        if (!ContentResolver.getMasterSyncAutomatically()
                || !ContentResolver.getSyncAutomatically(mAccount,
        ...
        if (listAdapter != null) {
            ...
            if (changes != null && changes.size() > 0) {
                for (CalendarRow row : changes.values()) {
                    ...
                    mService.startUpdate((int) id, null, uri, values, null,
                            null, 0);
                }
                changes.clear();
            }
