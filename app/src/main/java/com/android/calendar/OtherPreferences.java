...
public class OtherPreferences extends PreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        mQuietHoursStartDialog = new TimePickerDialog(activity,
                mQuietHoursStartListener, startHour, startMinute, mIs24HourMode);
        ...
        mQuietHoursEndDialog = new TimePickerDialog(activity,
                mQuietHoursEndListener, endHour, endMinute, mIs24HourMode);
