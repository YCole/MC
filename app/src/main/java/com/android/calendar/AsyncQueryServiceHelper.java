...
public class AsyncQueryServiceHelper extends IntentService {
    ...
    protected static class OperationInfo implements Delayed {
        ...
        @Override
        // Uncomment with Java6
        public long getDelay(TimeUnit unit) {
            return unit.convert(
                    mScheduledTimeMillis - SystemClock.elapsedRealtime(),
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!Utils.checkSelfPermission(this.getApplicationContext(),
                Manifest.permission.READ_CALENDAR)) {
            return;
        }
        ...
        synchronized (sWorkQueue) {
            while (true) {
                ...
                if (sWorkQueue.size() == 0) {
                    ...
                    long waitTime = first.mScheduledTimeMillis
