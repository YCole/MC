...
public class EditResponseHelper implements DialogInterface.OnClickListener,
    ...
    /**
     * This callback is passed in to this object when this object is created and
     * is invoked when the "Ok" button is selected.
     */
     ...
     *         apply the response: -1 means no choice selected, or the dialog
     *         was canceled. 0 means just the single event. 1 means all events.
     */
     ...
     * -1, the dialog was canceled out. If it is not -1, it's the index of which
     * events the user wants to respond to.
     * 
