...
public class AsyncQueryService extends Handler {
     ...
     * @param delayMillis
     *            delay in executing the operation. This operation will execute
     *            before the delayed time when another operation is added.
     *            Useful for implementing single level undo.
     */
    public void startInsert(int token, Object cookie, Uri uri,
            ContentValues initialValues, long delayMillis) {
        OperationInfo info = new OperationInfo();
     ...
     * @param selection
     *            A filter declaring which rows to update, formatted as an SQL
     *            WHERE clause (excluding the WHERE itself). Passing null will
     *            update all rows for the given URI.
     * @param selectionArgs
     *            You may include ?s in selection, which will be replaced by the
     *            values from selectionArgs, in the order that they appear in
     *            the selection. The values will be bound as Strings.
     ...
     * @param selection
     *            A filter declaring which rows to delete, formatted as an SQL
     *            WHERE clause (excluding the WHERE itself). Passing null will
     *            delete all rows for the given URI.
     * @param selectionArgs
     *            You may include ?s in selection, which will be replaced by the
     *            values from selectionArgs, in the order that they appear in
     *            the selection. The values will be bound as Strings.
     ...
     *            An object that gets passed into {@link #onDeleteComplete}
     * @param authority
     *            the authority used for the {@link ContentProviderOperation}.
     * @param cpo
     *            the {@link ContentProviderOperation} to be executed.
     * @param delayMillis
     *            delay in executing the operation. This operation will execute
     *            before the delayed time when another operation is added.
     *            Useful for implementing single level undo.
     ...
     *            the cookie object that's passed in from {@link #startDelete}.
     * @param results
     *            the result returned from executing the
