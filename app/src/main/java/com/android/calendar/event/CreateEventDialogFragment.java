...
/**
 * Allows the user to quickly create a new all-day event from the calendar's
 * month view.
 */
public class CreateEventDialogFragment extends DialogFragment implements
        TextWatcher {
    ...
    private static final String EVENT_DATE_FORMAT = "%a, %D ";
    ...
    public static final int ALL_DAY_DEFAULT_MINUTES = -9 * 60;
    ...
    public CreateEventDialogFragment(Time day, Handler handler) {
        mEventDialogHandler = handler;
        setDay(day);
    }

    public void setDay(Time day) {
        String dateS = CalendarApplication
                .getInstance()
                .getString(R.string.format_date_tip, day.year, day.month + 1,
                        day.monthDay).concat(day.format(" %a "));
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // save newEvent button ! found by pythoncat.cheng
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                try {
                                    if (mEventDialogHandler != null) {
                                        ...
                                        Log.e(TAG,
                                                "EventDialogHandler is null!");
                                    }
                                } catch (Exception e) {
                                    Log.e(TAG, "some error, print stack trace:"
                                            + e);
                                    e.printStackTrace();
                                }
                                dismiss();
    ...
    public void onResume() {
        ...
        if (mButtonAddEvent == null) {
            mButtonAddEvent = mAlertDialog
                    .getButton(DialogInterface.BUTTON_POSITIVE);
            mButtonAddEvent.setEnabled(mEventTitle.getText().toString()
                    .length() > 0);
        }
    }
    ...
    public void onActivityCreated(Bundle args) {
        ...
        mService.startQuery(TOKEN_CALENDARS, null, Calendars.CONTENT_URI,
                ...
                EditEventHelper.CALENDARS_WHERE_WRITEABLE_VISIBLE, null, null);
    }
    ...
    private void createAllDayEvent() {
        ...
        if (mModel.mReminders != null) {
            ...
            mModel.mReminders = new ArrayList<CalendarEventModel.ReminderEntry>();
        }
        mModel.mReminders.add(CalendarEventModel.ReminderEntry.valueOf(
                ALL_DAY_DEFAULT_MINUTES, Reminders.METHOD_ALERT));
        mModel.setEventColor(getActivity().getResources().getColor(
                R.color.event_color_blue));
        if (mEditEventHelper.saveEvent(mModel, null, 0)) {
            Toast.makeText(getActivity(), R.string.creating_event,
        ...
        while (cursor.moveToNext()) {
            ...
            if (defaultCalendar == null) {
                ...
                if (calendarOwner != null
                        && calendarOwner.equals(cursor
                                .getString(accountNameIndex))
                        && !CalendarContract.ACCOUNT_TYPE_LOCAL.equals(cursor
    ...
    private void setCalendarFields(Cursor cursor) {
        ...
        Drawable createDialogColor = getActivity().getResources().getDrawable(
                R.drawable.widget_agenda_item_color);
        createDialogColor.setTint(Utils.getDisplayColorFromColor(cursor
                .getInt(colorIndex)));
        mColor.setBackgroundDrawable(createDialogColor);
        ...
        if (mCalendarName != null) {
            ...
            String mycalendar = CreateEventDialogFragment.this
