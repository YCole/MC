...
/***  HCT_MODIFY combine 2.3 code, CQ00000000 humingyao, 2011-7-9 ***/
...
public class Regex {
     ...
     * </ul>
     */
    /* 2010-07-07, HCT_GUOQUAN_CRDB00516682 */
    /* 2010-07-20, HCT_GUOQUAN_CRDB00516682 */
    /*
     * public static final Pattern PHONE_PATTERN = Pattern.compile( // sdd =
     * space, dot, or dash "(\\+[0-9]+[\\- \\.]*)?" // +<digits><sdd>* +
     * "(\\([0-9]+\\)[\\- \\.]*)?" // (<digits>)<sdd>* +
    ...
    public static final Pattern PHONE_PATTERN_HCT = Pattern.compile( // sdd =
                                                                     // space,
                                                                     // dot, or
                                                                     // dash
            "(\\+[0-9]+[\\-\\.]*)?" // +<digits><sdd>*
                    + "(\\([0-9]+\\)[\\-\\.]*)?" // (<digits>)<sdd>*
                    + "([0-9][0-9\\-\\.][0-9\\-\\.]+[0-9])"); // <digit><digit|sdd>+<digit>
    /* end 2010-07-20, HCT_GUOQUAN_CRDB00516682 */

    /* end 2010-07-07, HCT_GUOQUAN_CRDB00516682 */
    /**
