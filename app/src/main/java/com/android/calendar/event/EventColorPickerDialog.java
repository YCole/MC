...
/**
 * A dialog which displays event colors, with an additional button for the
 * calendar color.
 */
public class EventColorPickerDialog extends ColorPickerDialog {
    ...
    public static EventColorPickerDialog newInstance(int[] colors,
            int selectedColor, int calendarColor, boolean isTablet) {
        EventColorPickerDialog ret = new EventColorPickerDialog();
        ret.initialize(R.string.event_color_picker_dialog_title, colors,
                selectedColor, NUM_COLUMNS, isTablet ? SIZE_LARGE : SIZE_SMALL);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mAlertDialog.setButton(DialogInterface.BUTTON_NEUTRAL, getActivity()
                .getString(R.string.event_color_set_to_default),
