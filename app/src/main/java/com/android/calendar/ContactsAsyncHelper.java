...
public class ContactsAsyncHelper extends Handler {
    ...
    public interface OnImageLoadCompleteListener {
         ...
         */
        public void onImageLoadComplete(int token, Object cookie,
    ...
    private class WorkerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case EVENT_LOAD_IMAGE:
                ...
                if (inputStream != null) {
                    args.result = Drawable.createFromStream(inputStream,
                            args.uri.toString());

                    if (DBG)
                        Log.d(LOG_TAG, "Loading image: " + msg.arg1
                                + " token: " + msg.what + " image URI: "
                                + args.uri);
                } else {
                    args.result = null;
                    if (DBG)
    ...
    public static final void updateImageViewWithContactPhotoAsync(
            Context context, ImageView imageView, Uri contact,
    ...
    public static final void retrieveContactPhotoAsync(Context context,
        ...
        if (DBG)
            Log.d(LOG_TAG, "Begin loading drawable: " + args.uri);
