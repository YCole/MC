...
public class Event implements Cloneable {
    ...
    public static void loadEvents(Context context, ArrayList<Event> events,
        ...
        try {
            ...
            cEvents = instancesQuery(context, EVENT_PROJECTION, startDay,
                    endDay, where, null, SORT_EVENTS_BY);
            cAllday = instancesQuery(context, EVENT_PROJECTION, startDay,
     ...
     */
    private static final Cursor instancesQuery(Context context,
        ...
        if (Utils.checkSelfPermission(context,
            ...
            return cr.query(builder.build(), projection, selection,
                    selectionArgs, orderBy == null ? DEFAULT_SORT_ORDER
                            : orderBy);
        }
        return null;
    }
