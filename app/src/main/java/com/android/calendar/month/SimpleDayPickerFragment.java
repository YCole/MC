 ...
 * </p>
 */
public class SimpleDayPickerFragment extends ListFragment implements
        OnScrollListener {
    ...
    public boolean goTo(long time, boolean animate, boolean setSelected,
        ...
        if (position < firstPosition || position > lastPosition || forceScroll) {
            ...
            position = Utils.getWeeksSinceEpochFromJulianDay(
                    Time.getJulianDay(millis, mFirstDayOfMonth.gmtoff),
                    mFirstDayOfWeek);
            ...
            if (animate) {
                ...
                mListView.smoothScrollToPositionFromTop(position,
                        LIST_TOP_OFFSET, GOTO_SCROLL_DURATION);
    ...
    protected class ScrollStateRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mNewState == OnScrollListener.SCROLL_STATE_IDLE
                ...
                // boolean scroll = firstPosition != 0 && lastPosition !=
                // mView.getCount() - 1;
