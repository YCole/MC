...
public class RecipientAlternatesAdapter extends CursorAdapter {
    ...
    public static HashMap<String, RecipientEntry> getMatchingRecipients(
            Context context, ArrayList<String> inAddresses) {
    ...
    public static HashMap<String, RecipientEntry> getMatchingRecipients(
        ...
        for (int i = 0; i < addressesSize; i++) {
            Rfc822Token[] tokens = Rfc822Tokenizer.tokenize(inAddresses.get(i)
                    .toLowerCase());
            addresses[i] = (tokens.length > 0 ? tokens[0].getAddress()
                    : inAddresses.get(i));
            bindString.append("?");
        ...
        Cursor c = context.getContentResolver().query(
                ...
                query.getProjection()[Queries.Query.DESTINATION] + " IN ("
                        + bindString.toString() + ")", addresses, null);
    ...
    public RecipientAlternatesAdapter(Context context, long contactId,
            long currentId, int viewId, OnCheckedItemChangedListener listener) {
