...
public interface MenuPresenter {
    ...
    public interface Callback {
         ...
         */
        public boolean onOpenSubMenu(com.gm.internal.menu.MenuBuilder subMenu);
    }

    /**
     * Initialize this presenter for the given context and menu.
     * This method is called by MenuBuilder when a presenter is
     * added. See {@link com.gm.internal.menu.MenuBuilder#addMenuPresenter(MenuPresenter)}
     *
     ...
     * {@link #initForMenu(Context, com.gm.internal.menu.MenuBuilder)}.
     *
