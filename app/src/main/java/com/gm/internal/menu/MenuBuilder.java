...
public class MenuBuilder implements Menu {
    ...
    private ArrayList<com.gm.internal.menu.MenuItemImpl> mItems;

    /** Contains only the items that are currently visible.  This will be created/refreshed from
     * {@link #getVisibleItems()} */
    private ArrayList<com.gm.internal.menu.MenuItemImpl> mVisibleItems;
    /**
     ...
     */
    private ArrayList<com.gm.internal.menu.MenuItemImpl> mActionItems;
    /**
     * Contains items that should NOT appear in the Action Bar, if present.
     */
    private ArrayList<com.gm.internal.menu.MenuItemImpl> mNonActionItems;
    ...
    private ArrayList<com.gm.internal.menu.MenuItemImpl> mTempShortcutItemList = new ArrayList<com.gm.internal.menu.MenuItemImpl>();

    private CopyOnWriteArrayList<WeakReference<com.gm.internal.menu.MenuPresenter>> mPresenters =
            new CopyOnWriteArrayList<WeakReference<com.gm.internal.menu.MenuPresenter>>();

    /**
     * Currently expanded menu item; must be collapsed when we clear.
     */
    private com.gm.internal.menu.MenuItemImpl mExpandedItem;
    ...
    public MenuBuilder(Context context) {
        ...
        mItems = new ArrayList<com.gm.internal.menu.MenuItemImpl>();

        mVisibleItems = new ArrayList<com.gm.internal.menu.MenuItemImpl>();
        mIsVisibleItemsStale = true;

        mActionItems = new ArrayList<com.gm.internal.menu.MenuItemImpl>();
        mNonActionItems = new ArrayList<com.gm.internal.menu.MenuItemImpl>();
     ...
     * {@link #removeMenuPresenter(com.gm.internal.menu.MenuPresenter)}.
     *
     * @param presenter The presenter to add
     */
    public void addMenuPresenter(com.gm.internal.menu.MenuPresenter presenter) {
     ...
     */
    public void addMenuPresenter(com.gm.internal.menu.MenuPresenter presenter, Context menuContext) {
        mPresenters.add(new WeakReference<com.gm.internal.menu.MenuPresenter>(presenter));
     ...
     */
    public void removeMenuPresenter(com.gm.internal.menu.MenuPresenter presenter) {
        for (WeakReference<com.gm.internal.menu.MenuPresenter> ref : mPresenters) {
            final com.gm.internal.menu.MenuPresenter item = ref.get();
    ...
    private void dispatchPresenterUpdate(boolean cleared) {
        ...
        for (WeakReference<com.gm.internal.menu.MenuPresenter> ref : mPresenters) {
            final com.gm.internal.menu.MenuPresenter presenter = ref.get();
            if (presenter == null) {
                mPresenters.remove(ref);
            } else {
    ...
    private boolean dispatchSubMenuSelected(SubMenuBuilder subMenu,
                                            com.gm.internal.menu.MenuPresenter preferredPresenter) {
    ...
    private MenuItem addInternal(int group, int id, int categoryOrder, CharSequence title) {
        ...
        final com.gm.internal.menu.MenuItemImpl item = createNewMenuItem(group, id, categoryOrder, ordering, title,
    ...
    private com.gm.internal.menu.MenuItemImpl createNewMenuItem(int group, int id, int categoryOrder, int ordering,
                                                                CharSequence title, int defaultShowAsAction) {
        return new com.gm.internal.menu.MenuItemImpl(this, group, id, categoryOrder, ordering, title,
                defaultShowAsAction);
    }
    ...
    public SubMenu addSubMenu(int group, int id, int categoryOrder, CharSequence title) {
        final com.gm.internal.menu.MenuItemImpl item = (com.gm.internal.menu.MenuItemImpl) addInternal(group, id, categoryOrder, title);
    ...
    void setExclusiveItemChecked(MenuItem item) {
        ...
        for (int i = 0; i < N; i++) {
            com.gm.internal.menu.MenuItemImpl curItem = mItems.get(i);
    ...
    public void setGroupCheckable(int group, boolean checkable, boolean exclusive) {
        ...
        for (int i = 0; i < N; i++) {
            com.gm.internal.menu.MenuItemImpl item = mItems.get(i);
    ...
    public int findGroupIndex(int group, int start) {
        ...
        for (int i = start; i < size; i++) {
            final com.gm.internal.menu.MenuItemImpl item = mItems.get(i);
    ...
    private static int findInsertIndex(ArrayList<com.gm.internal.menu.MenuItemImpl> items, int ordering) {
    ...
    public boolean performShortcut(int keyCode, KeyEvent event, int flags) {
        final com.gm.internal.menu.MenuItemImpl item = findItemWithShortcutForKey(keyCode, event);
     ...
     * with the keyCode.
     */
    void findItemsWithShortcutForKey(List<com.gm.internal.menu.MenuItemImpl> items, int keyCode, KeyEvent event) {
     ...
     */
    com.gm.internal.menu.MenuItemImpl findItemWithShortcutForKey(int keyCode, KeyEvent event) {
        // Get all items that can be associated directly or indirectly with the keyCode
        ArrayList<com.gm.internal.menu.MenuItemImpl> items = mTempShortcutItemList;
        items.clear();
    ...
    public boolean performItemAction(MenuItem item, com.gm.internal.menu.MenuPresenter preferredPresenter, int flags) {
        com.gm.internal.menu.MenuItemImpl itemImpl = (com.gm.internal.menu.MenuItemImpl) item;
    ...
    /**
     * Called by {@link com.gm.internal.menu.MenuItemImpl} when its visible flag is changed.
     * @param item The item that has gone through a visibility change.
     */
    void onItemVisibleChanged(com.gm.internal.menu.MenuItemImpl item) {
    ...
    /**
     * Called by {@link com.gm.internal.menu.MenuItemImpl} when its action request status is changed.
     * @param item The item that has gone through a change in action request status.
     */
    void onItemActionRequestChanged(com.gm.internal.menu.MenuItemImpl item) {
        // Notify of items being changed
        mIsActionItemsStale = true;
        onItemsChanged(true);
    }

    public ArrayList<com.gm.internal.menu.MenuItemImpl> getVisibleItems() {
        ...
        com.gm.internal.menu.MenuItemImpl item;
    ...
    public void flagActionItems() {
        ...
        final ArrayList<com.gm.internal.menu.MenuItemImpl> visibleItems = getVisibleItems();
    ...
    public ArrayList<com.gm.internal.menu.MenuItemImpl> getActionItems() {
        flagActionItems();
        return mActionItems;
    }
     ...
     * @hide
     */
    public ArrayList<com.gm.internal.menu.MenuItemImpl> getNonActionItems() {
        flagActionItems();
    ...
    public com.gm.internal.menu.MenuItemImpl getExpandedItem() {
