package com.gm.internal.app;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import gm.app.GomeMaxListView;
import gm.app.GomeScrollView;
...
public class GomeAlertController {
    ...
    private GomeScrollView mScrollView;
    ...
    public GomeAlertController(Context context, DialogInterface di, Window window) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
...
//        mAlertDialogLayout = R.layout.gome_alert_dialog;
//        mListLayout = R.layout.gome_select_dialog;
//        mMultiChoiceItemLayout = R.layout.gome_select_dialog_multichoice;
//        mSingleChoiceItemLayout = R.layout.gome_select_dialog_singlechoice;
//        mListItemLayout = R.layout.gome_select_dialog_item;
    }
...
//            mWindow.setCloseOnTouchOutsideIfNotSet(true);
    ...
    private void setupContent(LinearLayout contentPanel) {
        mScrollView = (GomeScrollView)mWindow.findViewById(R.id.scrollView);
        mScrollView.setScrollViewHeight(580);
...
//        }
    ...
    public static class AlertParams {
        ...
        public void apply(GomeAlertController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final GomeAlertController dialog) {
